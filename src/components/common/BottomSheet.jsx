export default function BottomSheet({ open, onClose, title, children }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      />
      <div
        className="relative z-10 max-h-[80vh] w-full max-w-md overflow-y-auto rounded-t-[1.75rem] border-t border-line bg-surface px-5 pt-5 shadow-2xl animate-[sheet_0.22s_cubic-bezier(0.16,1,0.3,1)]"
